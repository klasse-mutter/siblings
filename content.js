const artworks = {
  ...
  8: [{ artist: "elisabeth dimigen", title: "nët~\\z:w3rK", material: "repurposed network cables", instagram: "bettydelt", email: "edimigen@aol.com" }],
  9: [
  ...
  12: [{ artist: "iclal dönmez", title: "sudokey"}],
  ...
  15: [{ artist: "simon wegener", title: "untitled", material: "silicone, glycerin, carrageenan, water, ricepaper, aquarium, electronic device", instagram: "MeisterM0n" }],
  ...
  20: [{ artist: "anna bosch", title: "paradiesgarten", material: "canvas, colored pencil, watercolor", description: "Watercolor and colored pencils on paper and canvas. Evokes the inner feeling of connection to nature and the actually obvious." }],
  21: [{ artist: "anna bosch", title: "paradiesgarten", material: "canvas, oil paint, acrylic paint"}],
  22: [{ artist: "gökce zaloglu", title: "untitled", material: "photo print/pastel on paper", instagram: "gokce.zal"}],
  23: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025", instagram: "jakob.scheidt" }],
  24: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025", instagram: "jakob.scheidt" }],
  25: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025", instagram: "jakob.scheidt"}],
  ...
  29: [{ artist: "simon wegener", title: "The good one", material: "wood, ceramic tiles, water taps, aluminium trays, preserved blood", instagram: "MeisterM0n" }],
  ...
  32: [{ artist: "jakob scheidt", title: "Ohne Titel ", material: "Öl und Mischtechnik auf Leinwand", description: "200x260cm", instagram: "jakob.scheidt" }],
  33: [{ artist: "jakob scheidt", title: "Nautik", material: "Öl und Mischtechnik auf Leinwand", description: "200x140cm", instagram: "jakob.scheidt" }],
  13: [{ artist: "mu-in lü", title: "DHL & DFB"}],
  31: [{ artist: "sia lee", title: "untitled", material: "mixed media"}],
};
