const artworks = {
  ...
  2: [{ artist: "mona kurland", title: "untitled", material: "oil on canvas"}],
  3: [{ artist: "mona kurland", title: "untitled", material: "oil on canvas"}],
  ...
  19: [{ artist: "luise köhler", title: "de gode stube", material: "biobased leather alternative, cotton, wood, construction foam" }],
  ...
  22: [{ artist: "gökce zaloglu", title: "untitled", material: "photo print/pastel on paper"}],
  23: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025" }],
  24: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025" }],
  25: [{ artist: "jakob scheidt", title: "Ohne Titel", material: "Öl und Mischtechnik auf Leinwand", description: "30x40cm, 2025" }],
  30: [{ artist: "sofia yevmina", title: "title", material: "material", description: "desc" }],
  ...
  31: [{ artist: "jakob scheidt", title: "Ohne Titel ", material: "Öl und Mischtechnik auf Leinwand", description: "200x260cm" }],
  32: [{ artist: "jakob scheidt", title: "Nautik", material: "Öl und Mischtechnik auf Leinwand", description: "200x140cm" }],
